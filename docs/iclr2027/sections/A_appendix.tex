...
KU~Leuven and \R{extdtuloso5/eeg_centred/loso/acc} on DTU, against NeuroToken's
$0.634$ and $0.592$, and positive for every one of the
\R{extkulloso5/eeg_centred/loso/nfolds} and \R{extdtuloso5/eeg_centred/loso/nfolds}
held-out listeners. Within listeners it is not: NeuroToken reaches $0.864$ and
$0.837$ against our \R{extkulwithin5/eeg_centred/within/acc} and
\R{extdtuwithin5/eeg_centred/within/acc}, and DenseNet-3D is also higher on the four
KU~Leuven listeners it was run on. The five direction decoders were re-run within
